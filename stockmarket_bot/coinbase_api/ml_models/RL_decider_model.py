...
class CustomEnv(gym.Env):
    def __init__(self, asymmetry_factor=2):
        ...
        self.crypto_models = [Bitcoin, Ethereum, Polkadot]
        ...
        # Assume observation space is a vector of features from your ML models + additional financial indicators
        # Replace 100 with the actual number of features
        self.features = [
            'close',
            'volume',
            'sma',
        ...
        self.predicted_features = [
            'lstm_close_higher_shifted_1h',
            'lstm_close_higher_shifted_24h',
            'lstm_close_higher_shifted_168h',
            'xgboost_close_higher_shifted_1h',
            'xgboost_close_higher_shifted_24h',
            'xgboost_close_higher_shifted_168h',
        ]
        self.extra_features = ['holdings',]
    ...
    def reset(self):
        ...
        newest_crypto_data = self.get_new_crypto_data()
        eur_held = self.get_eur_held()
        # print(f'total volume: {total_volume}; eur_held: {eur_held}; account_holdings: {account_holdings}; newest_crypto_data: {newest_crypto_data}')
        next_state_concatenated = [total_volume, eur_held] + account_holdings + newest_crypto_data
        # print(f'next_state_concatenated: {next_state_concatenated}')
