"""
Django settings for stockmarket_bot project.
...
SECRET_KEY = '1pagx#sdfjtu@s&xlyta2ae5c25w9q_0b4^*r6sh1j5&wlgu^)'
...
ROOT_URLCONF = 'stockmarket_bot.urls'
...
WSGI_APPLICATION = 'stockmarket_bot.wsgi.application'
